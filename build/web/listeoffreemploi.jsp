            ...
            <div class="span7" style="padding: 45px 0;">
                <table id="example" class="table table-hover table-condensed" cellspacing="0" width="100%">
                    <thead>
                        ...
                        <tbody>
                            <c:forEach items="${ requestScope.listEmp }" var="emploi" varStatus="boucle">
                                <tr>
                                    <td>
                                    ...
                                    <td style="width: 30px">
                                        <a href="<c:url value="/DetailServlet?action=detailoffreemploi&id=${sessionScope.sessionUtilisateur.code.code}&codeEnt=${emploi.codeEnt.codeEnt}&codeOffreEmp=${emploi.codeOffreEmp}"/>" class="btn-mini btn-info" type="submit">
