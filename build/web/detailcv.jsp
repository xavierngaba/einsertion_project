                    ...
                    <div class="well sidebar-nav">
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="font-style: italic; color: #0480be"><c:out value="${Candidat.nomCan}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #000000">Prenom : </td>
                                <td style="font-style: italic ; color: #0480be"><c:out value="${Candidat.prenomCan}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #000000">&Acirc;ge : </td>
                                <td style="font-style: italic ; color: #0480be"><c:out value="${age}"/> ans</td>
                            </tr>
                            <tr>
                                <td style="color: #000000">Adresse : </td>
                                <td style="font-style: italic; color: #0480be"><c:out value="${Candidat.adresse}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #000000">Ville : </td>
                                <td style="font-style: italic; color: #0480be"><c:out value="${Candidat.villeCan}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #000000">T&eacute;l&eacute;phone : </td>
                                <td style="font-style: italic; color: #0480be"><c:out value="${Candidat.tel1Can}"/></td>
                            </tr>
                            <tr>
                                <td style="color: #000000">E-mail : </td>
                                <td style="font-style: italic; color: #0480be"><c:out value="${Candidat.emailCan}"/></td>
                            </tr>
                        </table>
                    </div>
                </div>
                                ...
                                <c:choose>
                                    <c:when test="${ empty requestScope.cv.competenceList}">
                                        <div class="alert alert-info" style="width: 40%; margin-left: 30%;">
                                            ...
                                            Actuellement aucune information concernant ses Comp&eacute;tences n'est enregistr&eacute; sur notre plate-forme
                                        </div>
                                    </c:when>
                                    <c:otherwise>
                            ...
                            <fieldset>
                                ...
                                <c:choose>
                                    <c:when test="${ empty requestScope.cv.experienceProList}">
                                        <div class="alert alert-info" style="width: 40%; margin-left: 30%;">
                                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                                            Actuellement aucune information concernant ses Exp&eacute;rience professionnelles n'est enregistr&eacute;e sur notre plate-forme
                                        </div>
                                    </c:when>
                                    <c:otherwise>
                            ...
                            <fieldset>
                                ...
                                <c:choose>
                                    <c:when test="${ empty requestScope.cv.formationList}">
                                        <div class="alert alert-info" style="width: 40%; margin-left: 30%;">
                                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                                            Actuellement aucune information concernant ses formations n'est enregistr&eacute; sur notre plate-forme
                                        </div>
                                    </c:when>
                                    <c:otherwise>
