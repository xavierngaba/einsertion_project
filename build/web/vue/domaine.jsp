<%-- 
    Document   : domaine
    Created on : Sep 24, 2014, 11:33:15 AM
    Author     : Dry Bass
--%>
...
<option value="Agriculture - pêche">Agriculture - p&ecirc;che</option>
...
<option value="Bagage, sacs et etuis">Bagage, sacs et &eacute;tuis</option>
...
<option value="Création entretien espaces verts">Cr&eacute;ation entretien espaces verts</option>
...
<option value="Droit de la propriete intéllectuelle">Droit de la propriété intéllectuelle</option>
...
<option value="Médias et publicite">Médias et publicité</option>
...
<option value="Mode,prete e porter,luxe">Mode,prête à porter,luxe</option>
...
<option value="Qualité,Hygiene,Securite,Environnement">Qualité,Hygiène,Sécurité,Environnement</option>
