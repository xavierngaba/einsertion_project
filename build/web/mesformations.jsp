...
<html>
    <head>
    <meta charset="utf-8">
    <title>E-insertion | Mes Formations</title>
                ...
                <table id="example" class="table table-hover table-condensed" cellspacing="0" width="100%">
                    <thead>
                        <tr class="text-info">
                                <th></th>
                                <th>Instituts</th>
                                <th style="width: 150px">Domaines</th>
                                <th>Lieux</th>
                                <th>Inscription du</th>
                                <th></th>
                                <th></th>
                            </tr>    
                        </thead>
                        <tbody>
                            <c:forEach items="${ requestScope.offreFormList }" var="form" varStatus="boucle">
                                <tr>
                                    <td>
                                    ...
                                    <td style="color: red">
                                        <c:out value="${sessionScope.sessionUtilisateur.getInscriptionList().get(boucle.index).getDateInsc()}"/>
                                    </td>
                                    <td>
                                        <a class="btn-small btn-info" href="<c:url value="/DetailServlet?action=detailoffreformation&id=${sessionScope.sessionUtilisateur.code.code}&codeIns=${form.codeIns.codeIns}&codeOffreForm=${form.codeOffreForm}"/>"><i class="icon-white icon-eye-open"></i></a>
                                    </td>
                                    <td>
                                        <a href="<c:url value="/InscriptionServlet?action=effacer&codeUser=${sessionScope.sessionUtilisateur.code.code}&codeOffreEmp=${form.codeOffreForm}"/>" class="btn-small btn-danger">
