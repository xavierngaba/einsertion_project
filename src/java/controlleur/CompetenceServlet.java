...
public class CompetenceServlet extends HttpServlet {
    ...
    public static final String VUE_PROFIL_FORM = "/modifcompetence.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
       String action = request.getParameter("action");
        Long codeComp = Long.parseLong(request.getParameter("codeComp"));
        ...
        if(action.equals("modifcomp")){
                Competence competence = compDAO.getCompetence(codeComp);
         ...
         }else if(action.equals("suprcomp")){
                compDAO.SuprCompetence(codeComp);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        if(action.equals("modifcomp")){
            try {
                ...
                form.modifCompetence(request, cv);
                cv.setFormationList(formDAO.getFormationCandidat(candidat));
