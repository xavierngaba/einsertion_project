 ...
 * @author Landry
 */
public class AfficherRencontre extends javax.swing.JFrame {

    /**
     * Creates new form AfficherRencontre
     */
    public AfficherRencontre() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calendrier des rencontres");
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        try {
            ...
            jTable2.setModel(new javax.swing.table.DefaultTableModel(
                        new Object [][] {
                            {matchDAO.chercherEquipeMatch(matchs.get(0).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(0).getId()).get(1).getNom() },                        
                            {matchDAO.chercherEquipeMatch(matchs.get(1).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(1).getId()).get(1).getNom() },
                            {matchDAO.chercherEquipeMatch(matchs.get(2).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(2).getId()).get(1).getNom() },                        
                            {matchDAO.chercherEquipeMatch(matchs.get(3).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(3).getId()).get(1).getNom() },
                        },
                        new String [] {
                            "   Equipe 1   ","-","  Equipe 2  "}
                ) );
        } catch (SQLException ex) {
            Logger.getLogger(AfficherRencontre.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jRadioButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton4ActionPerformed
        ...
        try {
            ...
            jTable2.setModel(new javax.swing.table.DefaultTableModel(
                        new Object [][] {
                            {matchDAO.chercherEquipeMatch(matchs.getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.getId()).get(1).getNom()},
                        },
                        new String [] {
                            "   Equipe 1   ","","-","","  Equipe 2  "}
                ) );
        ...
        try {
            ...
            jTable2.setModel(new javax.swing.table.DefaultTableModel(
                        new Object [][] {
                            ...
                            {matchDAO.chercherEquipeMatch(matchs.get(2).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(2).getId()).get(1).getNom() },                        
                            {matchDAO.chercherEquipeMatch(matchs.get(3).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(3).getId()).get(1).getNom() },
                            {matchDAO.chercherEquipeMatch(matchs.get(4).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(4).getId()).get(1).getNom() },                        
                            {matchDAO.chercherEquipeMatch(matchs.get(5).getId()).get(0).getNom()," - " ,matchDAO.chercherEquipeMatch(matchs.get(5).getId()).get(1).getNom() },
                        },
                        new String [] {
                            "   Equipe 1   ","-","  Equipe 2  "}
                ) );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficherRencontre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AfficherRencontre().setVisible(true);
            }
        });
    }
