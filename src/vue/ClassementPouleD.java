 ...
 * @author Landry
 */
public class ClassementPouleD extends javax.swing.JFrame {

    /**
     * Creates new form ClassementPoule
     */
    public ClassementPouleD() {
        initComponents();
        try {
            ...
            Poule poule = pouleDAO.afficher("D", edition.getId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassementPouleD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassementPouleD().setVisible(true);
            }
        });
    }
