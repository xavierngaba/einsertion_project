 ...
 * @author Landry
 */
public class ClassementPouleA extends javax.swing.JFrame {

    /**
     * Creates new form ClassementPoule
     */
    public ClassementPouleA() {
        initComponents();
        try {
            ...
            Poule poule = pouleDAO.afficher("A", edition.getId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassementPouleA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassementPouleA().setVisible(true);
            }
        });
    }
