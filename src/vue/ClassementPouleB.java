 ...
 * @author Landry
 */
public class ClassementPouleB extends javax.swing.JFrame {

    /**
     * Creates new form ClassementPoule
     */
    public ClassementPouleB() {
        initComponents();
        try {
            ...
            Poule poule = pouleDAO.afficher("B", edition.getId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassementPouleB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassementPouleB().setVisible(true);
            }
        });
    }
