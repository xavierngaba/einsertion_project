                        ...
                        <div class="span7">
                            <div class="tabbable"> <!-- Only required for left/right tabs -->
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab2" data-toggle="tab">Comp&eacute;tence</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab2">
                                        <form action="<c:url value="/CompetenceServlet"/>" method="post">
                                            <input type="hidden" name="codeCan" value="<c:out value="${sessionScope.sessionUtilisateur.codeCan}"/>"/>
                                            <input type="hidden" name="codeComp" value="<c:out value="${competence.codeComp}"/>">
                                            <input type="hidden"  name="action" value="modifcomp"/>
                                                            ...
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <div class="input-prepend">
                                                                        ...
                                                                        <input type="text" name="domaine" placeholder="domaine" value="<c:out value="${competence.domaine}"/>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <div class="input-prepend">
                                                                        ...
                                                                        <input type="text" name="specialite" placeholder="Spécialité" value="<c:out value="${competence.specialite}"/>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <div class="input-prepend">
                                                                        <span class="add-on"><i class="icon-home"></i></span>
                                                                        <textarea name="description" placeholder="description domaine" cols="15" rows="5"><c:out value="${competence.libelleComp}"/></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
