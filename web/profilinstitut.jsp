                            ...
                            <div class="well sidebar-nav">
                                <div id="affiche" style="margin-left: 25px">
                                    <table>
                                         <tr>
                                             <td colspane="7">
                                                 <img class="img-polaroid" alt="Photo de profil" width="210px" height="210px" src="<c:url value="images/profil/images4.jpg"/>">
                                             </td>
                                             <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                             <td>
                                                 <dl>
                                                     <dd class="text-info" style="font-style: italic; font-size: 45px"><c:out value="${sessionScope.sessionUtilisateur.nomIns}"/>
                                         ...
                                         <tr>
                                             <td>
                                                 <button class="btn btn-primary" href="#" onclick="hide('affiche');show('photo');"><i class="icon-pencil icon-white"></i> Modifier votre photo de Profil</button>
                                             </td>
                                         </tr>
                                      </table>
                                      <br/>
                                    <table>
                                        <tr>
                                            <dl>
                                                ...
                                                <dd style="color: seagreen; font-style: italic; font-size: 25px"><c:out value="${sessionScope.sessionUtilisateur.telIns}"/></dd>
                                            </dl>
                                            <dl>
                                                <dt style="color: #0088cc; font-style: italic; font-size: 20px">Site: </dt>
                                                <dd style="color: seagreen; font-style: italic; font-size: 25px"><c:out value="${sessionScope.sessionUtilisateur.siteIns}"/></dd>
                                            </dl>
                                            <dl>
                                                <dt style="color: #0088cc; font-style: italic; font-size: 20px">Description: </dt>
                                                <dd style="color: seagreen; font-style: italic; font-size: 25px"><c:out value="${sessionScope.sessionUtilisateur.descripIns}"/></dd>
                                            </dl>
                                            <dl>
                                                <dt style="color: #0088cc; font-style: italic; font-size: 20px">Responsable: </dt>
                                                <dd style="color: seagreen; font-style: italic; font-size: 25px"><c:out value="${sessionScope.sessionUtilisateur.nomRespIns}"/>&nbsp;<c:out value="${sessionScope.sessionUtilisateur.prenomRespIns}"/></dd>
                                            </dl>
                                            <dl>
                                                <dt style="color: #0088cc; font-style: italic; font-size: 20px">E-mail: </dt>
                                                <dd style="color: seagreen; font-style: italic; font-size: 25px"><c:out value="${sessionScope.sessionUtilisateur.emailIns}"/></dd>
                                            </dl>
                                        </tr>
                                    </table> 
                                </div>
                                <div id="photo" style="display:none; margin-left: 25px">
                                    <form action="<c:url value="upload" />" method="post" enctype="multipart/form-data">
                                        ...
                                        <button class="btn btn-inverse" type="reset" onclick="hide('photo');show('affiche');"><i class="icon-remove icon-white"></i> Annuler</button>
                                        <br />
                                    </form>
                                </div>
                                <div id="modifprofil" style="display: none;">
                                    <c:import url="vue/modifinstitut.jsp" />
                                </div>
                            </div>
                        </div>
                    <div class="span2">
